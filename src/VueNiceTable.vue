    ...
    <table :class="tableClasses">
      ...
      >
        <tr
          ...
          :key="item_key"
          :class="item.trClass"
          @dblclick="$emit('row-db-clicked',item)"
...
let emits = defineEmits(['sortChanged','update:sortBy','update:sortDesc','rowDbClicked','rowClicked']);
...
let tableItems = computed(()=>{
	...
	return sortItems(props.items, props.sortBy, props.sortDesc);
});
...
let tableResponsiveClass = computed(()=>{
	let class_str = '';
	if(!props.responsive) {
		return class_str
	}
	...
	case 'sm': 
		class_str='table-responsive-sm';break;
	case 'md': 
		class_str='table-responsive-md';break;
	case 'lg': 
		class_str='table-responsive-lg';break;
	case 'xl': 
		class_str='table-responsive-xl';break;
	default: 
		class_str='table-responsive';break;
	}
	return class_str;
});
